...
const FormikSignUpForm = withFormik({
  ...
  validationSchema: Yup.object().shape({
    ...
    email: Yup.string()
      .email()
      .required('You must enter in a email'),
    password: Yup.string()
      .min(8, 'Your password must be atleast 8 characters long')
      .required('You must enter in a password'),
    child_name: Yup.string().required(
      'What did you not give your child a name...'
    ),
